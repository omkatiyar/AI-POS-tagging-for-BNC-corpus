...
import numpy as np
import itertools
file = open('./Desktop/ML/train_data_sentences/train_combine.txt', encoding="utf8")
train_set= file.read()
...
test_file=open("./Desktop/ML/Test_data_sentences/test_sentences_combined.txt",encoding="utf8")
